...
mixin _$LikeModel {
 ...
 String get postId; String get likeCount;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LikeModel&&(identical(other.postId, postId) || other.postId == postId)&&(identical(other.likeCount, likeCount) || other.likeCount == likeCount));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,postId,likeCount);

@override
String toString() {
  return 'LikeModel(postId: $postId, likeCount: $likeCount)';
}
...
@useResult
$Res call({
 String postId, String likeCount
});
...
/// Create a copy of LikeModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? postId = null,Object? likeCount = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String postId,  String likeCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LikeModel() when $default != null:
return $default(_that.postId,_that.likeCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String postId,  String likeCount)  $default,) {final _that = this;
switch (_that) {
case _LikeModel():
return $default(_that.postId,_that.likeCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String postId,  String likeCount)?  $default,) {final _that = this;
switch (_that) {
case _LikeModel() when $default != null:
return $default(_that.postId,_that.likeCount);case _:
  return null;
...
class _LikeModel implements LikeModel {
  const _LikeModel({required this.postId, required this.likeCount});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LikeModel&&(identical(other.postId, postId) || other.postId == postId)&&(identical(other.likeCount, likeCount) || other.likeCount == likeCount));
}
...
/// Create a copy of LikeModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? postId = null,Object? likeCount = null,}) {
